...
plt.title('Step Model PSTH For Different Gamma Shapes (5000 trials)')
plt.legend()
plt.grid()
...
plt.title('Step Model Fano Factor For Different Gamma Shapes (50000 trials)')
plt.legend()
plt.grid()
...
plt.xlabel('Time (ms)')
plt.ylabel('Firing Rate (Hz)')
plt.title('Ramp Model PSTH For Different Gamma Shapes (5000 trials)')
plt.legend()
plt.grid()
...
plt.xlabel('Time (ms)')
plt.ylabel('Fano Factor')
plt.title('Ramp Model Fano Factor For Different Gamma Shapes (50000 trials)')
plt.legend()
plt.grid()
